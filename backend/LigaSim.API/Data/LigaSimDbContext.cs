...
public class LigaSimDbContext(DbContextOptions<LigaSimDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Team>().HasData(
            ...
            new Team { Id = 12, Name = "Sevilla",        ShortName = "SEV", FoundingYear = 1890, PrimaryColor = "#d81920", Power = 80, Morale = 48, Manager = "García Pimienta",     Stadium = "Ramón Sánchez-Pizjuán",  Capacity = "43,883",  LogoColor = "bg-red-700 border-slate-200",      LogoUrl = "https://crests.football-data.org/83.svg" },
